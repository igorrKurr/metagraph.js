define(['./utils', './edge'], function (Utils, Edge) {
  "use strict";
  return function() {
    ...
    proto._addRelator = function(relator, relation, type) {
      ...
      if (!type) {
        relation === 'parents' ? proto._createEdge(relator, proto) : proto._createEdge(proto, relator);
      };
    };

    proto._createEdge = function(from, to){
      if (!this.graph) {return;}
      this.graph.addEdge(Edge(from, to));
    };
